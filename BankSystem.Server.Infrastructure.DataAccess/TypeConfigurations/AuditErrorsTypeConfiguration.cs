...
{
    public class AuditErrorsTypeConfiguration : IEntityTypeConfiguration<AuditError>
    {
        public void Configure(EntityTypeBuilder<AuditError> builder)
        {
            builder.ToTable("AUDIT_ERROR");
